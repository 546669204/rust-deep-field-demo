...
zip –q –r "$OS_FAMILY.zip" -x=target/release/build -x=target/release/bundle -x=target/release/deps -x=target/release/examples -x=target/release/incremental target/release/* 